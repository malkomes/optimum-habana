...
def _update_default_model_kwargs(model_kwargs):
...
class GenerationIntegrationTests(unittest.TestCase, GenerationIntegrationTestsMixin):
    ...
    def test_max_length_backward_compat_greedy(self):
        ...
        _update_default_model_kwargs(model_kwargs)
    ...
    def test_transition_scores_group_beam_search_encoder_decoder(self):
        ...
        assert "Group beam search is not supported by optimum-habana yet" in str(excinfo.value)
    ...
    def test_batched_decoder_start_id(self):
        ...
        #decoder_start_token_id_batch = torch.tensor(decoder_start_token_id_batch, device=torch_device)
    ...
    def test_default_max_length_warning(self):
        ...
        # NOTE: GaudiGenerationMixin changes the `input_ids_length` with token_idx
    ...
    def test_model_kwarg_assisted_decoding_decoder_only(self):
        ...
        assert "Assisted decoding is not supported by optimum-habana yet" in str(excinfo.value)
        pytest.xfail("Not supported by optimum-habana yet")
